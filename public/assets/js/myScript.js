...
//Sweetalert Delete Confirm Data Surat Masuk
$(document).ready(function() {
  $('.hapus_sm').on('click', function(e) {
    e.preventDefault();
    var id = $(this).val();
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        document.location.href = '/surat_masuk/delete/'+id;
      }
    });
  });
});

//Sweetalert Delete Confirm Data Surat Keluar
$(document).ready(function() {
	$('.hapus_sk').on('click', function(e) {
	  e.preventDefault();
	  var id = $(this).val();
	  ...
	  Swal.fire({
		...
		if (result.isConfirmed) {
		  document.location.href = '/surat_keluar/delete/'+id;
		}
	  });
	});
  });
 ...
 $(document).ready(function() {
   $("#surat_masuk, #surat_keluar").DataTable({
     "responsive": true, 
     "lengthChange": true,
   ...
   }).buttons().container().appendTo('#surat_masuk_wrapper .col-md-6:eq(0), #surat_keluar_wrapper .col-md-6:eq(0)');
 });
